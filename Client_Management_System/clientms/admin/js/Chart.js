(function (root, factory) {
        ...
        function (e, r, t) {
          !(function () {
            var t = e("color-convert"),
              ...
              a = function (e) {
                ...
                if (
                  ...
                  var r = e;
                  if (void 0 !== r.r || void 0 !== r.red)
                    this.setValues("rgb", r);
                  else if (void 0 !== r.l || void 0 !== r.lightness)
                    this.setValues("hsl", r);
                  else if (void 0 !== r.v || void 0 !== r.value)
                    this.setValues("hsv", r);
                  else if (void 0 !== r.w || void 0 !== r.whiteness)
                    this.setValues("hwb", r);
                  else {
            ...
            (a.prototype = {
              ...
              negate: function () {
                for (var e = [], r = 0; 3 > r; r++)
                  e[r] = 255 - this.values.rgb[r];
                return this.setValues("rgb", e), this;
              },
              lighten: function (e) {
                return (
                  (this.values.hsl[2] += this.values.hsl[2] * e),
              ...
              saturate: function (e) {
                return (
                  (this.values.hsl[1] += this.values.hsl[1] * e),
                  this.setValues("hsl", this.values.hsl),
                  this
                );
              },
              ...
              whiten: function (e) {
                return (
                  (this.values.hwb[1] += this.values.hwb[1] * e),
              ...
              blacken: function (e) {
                return (
                  (this.values.hwb[2] += this.values.hwb[2] * e),
                  this.setValues("hwb", this.values.hwb),
                  this
                );
              },
              ...
              clearer: function (e) {
                return (
                  this.setValues(
                    "alpha",
                    this.values.alpha - this.values.alpha * e
                  ),
                  this
                );
              },
              ...
              (a.prototype.setValues = function (e, r) {
                ...
                if ("alpha" == e) s = r;
                  ...
                  (this.values[e] = r.slice(0, e.length)), (s = r[e.length]);
                else if (void 0 !== r[e.charAt(0)]) {
                  for (var i = 0; i < e.length; i++)
                    this.values[e][i] = r[e.charAt(i)];
                  s = r.a;
                } else if (void 0 !== r[n[e][0]]) {
                  for (var u = n[e], i = 0; i < e.length; i++)
                    this.values[e][i] = r[u[i]];
                  s = r.alpha;
                }
                if (
        ...
        function (e, t, n) {
          ...
          function u(e) {
            var r,
              ...
              u = e[2] / 255;
            return (
              (a = Math.min(1 - s, 1 - i, 1 - u)),
              (r = (1 - s - a) / (1 - a) || 0),
              (t = (1 - i - a) / (1 - a) || 0),
              (n = (1 - u - a) / (1 - a) || 0),
              [100 * r, 100 * t, 100 * n, 100 * a]
            );
          }
          function l(e) {
          ...
          function h(e) {
            ...
            var a = 0.4124 * r + 0.3576 * t + 0.1805 * n,
              s = 0.2126 * r + 0.7152 * t + 0.0722 * n,
              i = 0.0193 * r + 0.1192 * t + 0.9505 * n;
          ...
          function E(e) {
            var r,
              ...
              i = e[2] / 100;
            return (
              (r = 3.2406 * a + -1.5372 * s + i * -0.4986),
              (t = a * -0.9689 + 1.8758 * s + 0.0415 * i),
              (n = 0.0557 * a + s * -0.204 + 1.057 * i),
              (r =
                r > 0.0031308
          ...
          function j(e) {
            ...
            return (
              8 >= s
                ...
                : ((t = 100 * Math.pow((s + 16) / 116, 3)),
                  (a = Math.pow(t / 100, 1 / 3))),
              (r =
                0.008856 >= r / 95.047
                  ? (r = (95.047 * (i / 500 + a - 16 / 116)) / 7.787)
                  : 95.047 * Math.pow(i / 500 + a, 3)),
              (n =
                0.008859 >= n / 108.883
                  ? (n = (108.883 * (a - u / 200 - 16 / 116)) / 7.787)
                  : 108.883 * Math.pow(a - u / 200, 3)),
              [r, t, n]
            );
          }
          function J(e) {
        ...
        function (e, r, t) {
          ...
          (h.prototype.routeSpace = function (e, r) {
            ...
            (h.prototype.setValues = function (e, r) {
              return (
                (this.space = e), (this.convs = {}), (this.convs[e] = r), this
              );
            }),
            ...
            if (e) {
              ...
              if (l) {
                ...
                for (var h = 0; h < i.length; h++)
                  i[h] = parseInt(l[h] + l[h], 16);
              } else if ((l = e.match(t))) {
                l = l[1];
                for (var h = 0; h < i.length; h++)
                  i[h] = parseInt(l.slice(2 * h, 2 * h + 2), 16);
              } else if ((l = e.match(n))) {
                for (var h = 0; h < i.length; h++) i[h] = parseInt(l[h + 1]);
                u = parseFloat(l[4]);
              } else if ((l = e.match(a))) {
                for (var h = 0; h < i.length; h++)
                  i[h] = Math.round(2.55 * parseFloat(l[h + 1]));
                u = parseFloat(l[4]);
              } else if ((l = e.match(s))) {
  ...
  (function () {
    ...
    helpers.getConstraintWidth = function (domNode) {
      ...
      var constrainedWNode =
        document.defaultView.getComputedStyle(domNode)["max-width"];
      var constrainedWContainer = document.defaultView.getComputedStyle(
        domNode.parentNode
      )["max-width"];
      var hasCWNode = constrainedWNode !== null && constrainedWNode !== "none";
      var hasCWContainer =
        constrainedWContainer !== null && constrainedWContainer !== "none";

      if (hasCWNode || hasCWContainer) {
        constrainedWidth = Math.min(
          hasCWNode ? parseInt(constrainedWNode, 10) : Number.POSITIVE_INFINITY,
          hasCWContainer
            ? parseInt(constrainedWContainer, 10)
    ...
    helpers.getConstraintHeight = function (domNode) {
      ...
      var constrainedHNode =
        document.defaultView.getComputedStyle(domNode)["max-height"];
      var constrainedHContainer = document.defaultView.getComputedStyle(
        domNode.parentNode
      )["max-height"];
      var hasCHNode = constrainedHNode !== null && constrainedHNode !== "none";
      var hasCHContainer =
        constrainedHContainer !== null && constrainedHContainer !== "none";

      if (constrainedHNode || constrainedHContainer) {
        constrainedHeight = Math.min(
          hasCHNode ? parseInt(constrainedHNode, 10) : Number.POSITIVE_INFINITY,
          hasCHContainer
            ? parseInt(constrainedHContainer, 10)
            : Number.POSITIVE_INFINITY
        );
      }
  ...
  (function () {
    ...
    helpers.extend(Chart.Controller.prototype, {
      ...
      resize: function resize(silent) {
        ...
        var sizeChanged =
          this.chart.width !== newWidth || this.chart.height !== newHeight;
        ...
        helpers.each(
          ...
          function (dataset, datasetIndex) {
            ...
            if (dataset.controller) {
              ...
              dataset.controller = new Chart.controllers[type](
                this,
                datasetIndex
              );
          ...
          for (var i = 0; i < this.data.datasets.length; i++) {
            if (helpers.isDatasetVisible(this.data.datasets[i])) {
              for (var j = 0; j < this.data.datasets[i].metaData.length; j++) {
                if (
                  this.data.datasets[i].metaData[j].inRange(
                    eventPosition.x,
                    eventPosition.y
                  )
                ) {
      ...
      getDatasetAtEvent: function (e) {
        ...
        if (elementsArray.length > 0) {
          elementsArray =
            this.data.datasets[elementsArray[0]._datasetIndex].metaData;
        }
          ...
          if (this.isHorizontal()) {
            ...
            helpers.each(
              ...
              function (legendItem, i) {
                ...
                if (
                  this.lineWidths[this.lineWidths.length - 1] + width >=
                  this.width
                ) {
                  totalHeight +=
                    this.options.labels.fontSize + this.options.labels.padding;
            ...
            helpers.each(
              ...
              function (legendItem, i) {
                ...
                if (cursor.x + width >= this.width) {
                  ...
                  cursor.line++;
                  cursor.x =
                    this.left + (this.width - this.lineWidths[cursor.line]) / 2;
                }
    ...
    Chart.Scale = Chart.Element.extend({
        ...
        if (this.options.display) {
          if (this.isHorizontal()) {
            ...
            while (
              ...
              if (
                firstRotated + this.options.ticks.fontSize / 2 >
                this.yLabelWidth
              ) {
                this.paddingLeft =
                  firstRotated + this.options.ticks.fontSize / 2;
      ...
      fit: function () {
        ...
        if (this.isHorizontal()) {
          ...
          this.minSize.width =
            this.options.gridLines.display && this.options.display ? 10 : 0;
        }
        ...
        if (this.options.ticks.display && this.options.display) {
          ...
          if (this.isHorizontal()) {
            ...
            this.longestLabelWidth = helpers.longestText(
              this.ctx,
              labelFont,
              this.ticks
            );
      ...
      draw: function (chartArea) {
        if (this.options.display) {
          ...
          if (this.isHorizontal()) {
            ...
            var yTickStart =
              this.options.position === "bottom" ? this.top : this.bottom - 10;
            var yTickEnd =
              this.options.position === "bottom" ? this.top + 10 : this.bottom;
            skipRatio = false;

            if (
              (longestRotatedLabel / 2 + this.options.ticks.autoSkipPadding) *
                this.ticks.length >
            ...
            if (this.options.scaleLabel.display) {
              ...
              this.ctx.font = helpers.fontString(
            ...
            setContextLineSettings = true;
            var xTickStart =
              this.options.position === "right" ? this.left : this.right - 5;
            var xTickEnd =
              this.options.position === "right" ? this.left + 5 : this.right;
    ...
    Chart.Title = Chart.Element.extend({
      ...
      fit: function () {
        ...
        if (this.isHorizontal()) {
          ...
          if (this.options.display) {
            this.minSize.height +=
              this.options.fontSize + this.options.padding * 2;
          }
        } else {
          // TODO vertical
        }
          ...
          if (this._options.tooltips.mode === "single") {
            ...
            tooltipItems.push({
              xLabel: element._xScale
                ...
                : "",
              yLabel: yScale
                ? yScale.getLabelForIndex(element._index, element._datasetIndex)
                : "",
  ...
  (function () {
    ...
    Chart.controllers.bar = Chart.DatasetController.extend({
      ...
      addElements: function () {
        ...
        helpers.each(
          ...
          function (value, index) {
            this.getDataset().metaData[index] =
              this.getDataset().metaData[index] ||
        ...
        if (yScale.options.stacked) {
          ...
          if (value < 0) {
            for (var i = 0; i < datasetIndex; i++) {
              ...
              if (
                helpers.isDatasetVisible(negDS) &&
                negDS.yAxisID === yScale.id &&
                negDS.bar
              ) {
            ...
            for (var j = 0; j < datasetIndex; j++) {
              ...
              if (
                helpers.isDatasetVisible(posDS) &&
                posDS.yAxisID === yScale.id &&
                posDS.bar
              ) {
      ...
      getBarIndex: function (datasetIndex) {
        ...
        for (var j = 0; j < datasetIndex; ++j) {
          if (
            helpers.isDatasetVisible(this.chart.data.datasets[j]) &&
            this.chart.data.datasets[j].bar
          ) {
            ++barIndex;
          }
        }
      ...
      calculateBarY: function (index, datasetIndex) {
        ...
        if (yScale.options.stacked) {
          ...
          for (var i = 0; i < datasetIndex; i++) {
            ...
            if (
              helpers.isDatasetVisible(ds) &&
              ds.bar &&
              ds.yAxisID === yScale.id
            ) {
              if (ds.data[index] < 0) {
      ...
      Chart.DatasetController.extend({
        ...
        update: function update(reset) {
          ...
          this.chart.outerRadius = Math.max(
            minSize / 2 - this.chart.options.elements.arc.borderWidth / 2,
            0
          );
          ...
          if (!reset) {
            if (index === 0) {
              ...
              arc._model.startAngle =
                this.getDataset().metaData[index - 1]._model.endAngle;
            }
            ...
            if (index < this.getDataset().data.length - 1) {
              this.getDataset().metaData[index + 1]._model.startAngle =
                arc._model.endAngle;
            }
          }
    ...
    Chart.controllers.line = Chart.DatasetController.extend({
      ...
      calculatePointY: function (value, index, datasetIndex, isCombo) {
        ...
        if (yScale.options.stacked) {
          ...
          for (
            var i = this.chart.data.datasets.length - 1;
            i > datasetIndex;
            i--
          ) {
            var ds = this.chart.data.datasets[i];
        ...
        helpers.each(
          ...
          function (point, index) {
            ...
            point._model.controlPointPreviousX = Math.max(
              Math.min(controlPoints.previous.x, this.chart.chartArea.right),
              this.chart.chartArea.left
            );
            point._model.controlPointPreviousY = Math.max(
              Math.min(controlPoints.previous.y, this.chart.chartArea.bottom),
    ...
    Chart.controllers.radar = Chart.DatasetController.extend({
      ...
      update: function update(reset) {
        ...
        helpers.extend(this.getDataset().metaDataset, {
          ...
          _model: {
            // Appearance
            tension: helpers.getValueOrDefault(
              this.getDataset().tension,
              this.chart.options.elements.line.tension
            ),
            backgroundColor:
            ...
            fill:
              this.getDataset().fill !== undefined
                ? this.getDataset().fill
                : this.chart.options.elements.line.fill, // use the value from the this.getDataset() if it was provided. else fall back to the default
      ...
      updateBezierControlPoints: function () {
        helpers.each(
          ...
          function (point, index) {
            var controlPoints = helpers.splineCurve(
              helpers.previousItem(this.getDataset().metaData, index, true)
                ._model,
              point._model,
        ...
        if (this.options.stacked) {
          ...
          helpers.each(
            ...
            function (dataset) {
              ...
              if (
                helpers.isDatasetVisible(dataset) &&
                (this.isHorizontal()
                  ? dataset.xAxisID === this.id
                  : dataset.yAxisID === this.id)
              ) {
                helpers.each(
                  dataset.data,
  ...
  (function () {
    ...
    var LinearRadialScale = Chart.Scale.extend({
        ...
        for (i = 0; i < this.getValueCount(); i++) {
          ...
          textWidth =
            this.ctx.measureText(
              this.options.ticks.callback(this.chart.data.labels[i])
            ).width + 5;
      ...
      getPointPosition: function (index, distanceFromCenter) {
        ...
        return {
          x:
            Math.round(Math.cos(thisAngle) * distanceFromCenter) + this.xCenter,
          y:
            Math.round(Math.sin(thisAngle) * distanceFromCenter) + this.yCenter,
        };
      },
    ...
    var TimeScale = Chart.Scale.extend({
      ...
      buildTicks: function (index) {
        ...
        if (this.options.time.unit) {
          ...
          this.tickRange = Math.ceil(
            this.lastTick.diff(this.firstTick, this.tickUnit, true) + buffer
          );
          this.displayFormat = this.options.time.displayFormats[this.tickUnit];
          ...
          while (unitDefinitionIndex < time.units.length) {
            ...
            if (
              ...
              Math.ceil(this.tickRange / labelCapacity) <
              ...
              this.tickRange = Math.ceil(
                this.lastTick.diff(this.firstTick, this.tickUnit) + buffer
              );
              this.displayFormat =
        ...
        for (var i = 0; i <= this.tickRange; ++i) {
          if (i % this.unitScale === 0) {
            ...
            this.tickRange =
              Math.ceil(this.tickRange / this.unitScale) * this.unitScale;
            this.ticks.push(
      ...
      getLabelForIndex: function (index, datasetIndex) {
        ...
        if (
          typeof this.chart.data.datasets[datasetIndex].data[0] === "object"
        ) {
  ...
  (function () {
    ...
    Chart.elements.Line = Chart.Element.extend({
      ...
      draw: function () {
        ...
        if (ctx.setLineDash) {
          ctx.setLineDash(
            vm.borderDash || Chart.defaults.global.elements.line.borderDash
          );
        }
        ...
        ctx.lineJoin =
          ...
          Chart.defaults.global.elements.line.borderJoinStyle;
        ctx.lineWidth =
          vm.borderWidth || Chart.defaults.global.elements.line.borderWidth;
      ...
      draw: function () {
        ...
        if (vm.radius > 0 || vm.borderWidth > 0) {
          ...
          ctx.arc(
            vm.x,
            vm.y,
            vm.radius || Chart.defaults.global.elements.point.radius,
            0,
            Math.PI * 2
          );
          ctx.closePath();
          ...
          ctx.lineWidth =
            vm.borderWidth || Chart.defaults.global.elements.point.borderWidth;
