      ...
      var fe = function (t, e, i, r) {
        ...
        de = (a.parseComplex = function (t, e, i, r, s, n, a, o, l, h) {
          ...
          for (
            ...
            if (((c = C[f]), (d = R[f]), (x = parseFloat(c)), x || 0 === x))
              a.appendXtra(
                "",
                x,
                se(d, x),
                ...
                T && !U && 0 === d[3]
                  ...
                  : (U || (T = !1),
                    a
                      ...
                      .appendXtra("", c[1], d[1] - c[1], ",", !0)
                      .appendXtra("", c[2], d[2] - c[2], T ? "," : S, !0),
                    T &&
                      ((c = 4 > c.length ? 1 : c[3]),
                      a.appendXtra(
                        "",
            ...
            ve(t, {
              parser: function (t, i, r, s, n, a, h) {
                ...
                return u
                  ...
                  : (W("Error: " + e + " js file not loaded."), n);
              },
            });
          }
        };
      (h = ge.prototype),
        ...
        (h.parse = function (t, e, i, r, n, a) {
          return this.parseComplex(
            t.style,
            this.format(G(t, this.p, s, !1, this.dflt)),
            this.format(e),
            n,
            a
          );
      ...
      var xe,
        ...
        Me = (Y.getTransform = function (t, e, i, r) {
          ...
          var n,
            ...
            y = 1e5,
            x = Se
              ? parseFloat(G(t, Pe, e, !1, "0 0 0").split(" ")[2]) ||
                m.zOrigin ||
                0
              : 0,
            ...
            if (16 === l.length) {
              ...
              (m.rotation = W * N),
                ...
                W &&
                  ...
                  (Y = O),
                  (B = D)),
                (m.scaleX = (0 | (Math.sqrt(z * z + X * X) * y + 0.5)) / y),
                (m.scaleY = (0 | (Math.sqrt(Y * Y + b * b) * y + 0.5)) / y),
                (m.scaleZ = (0 | (Math.sqrt(B * B + P * P) * y + 0.5)) / y),
                (m.skewX = 0),
        ...
        Ne = (Y.set3DTransformRatio = function (t) {
          ...
          (f = 1),
            ...
            R.svg &&
              ((s += R.xOrigin - (R.xOrigin * e + R.yOrigin * i)),
            ...
            ? ((s = p.scaleX),
              ...
              p.rotation || p.skewX || p.svg
                ...
                : (c[we] =
                    ...
                    ")"),
              void 0)
            : ((this.setRatio = Ne), Ne.call(this, t), void 0);
        });
      (h = Ce.prototype),
        (h.x =
          h.y =
        ...
        ve(
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
          {
            parser: function (t, e, i, r, n, o, l) {
              ...
              for (
                Se && null != x.force3D && ((m.force3D = x.force3D), (c = !0)),
              ...
              return (
                ...
                c &&
                  (r._transformType =
                    (m.svg && xe) || (!_ && 3 !== this._transformType) ? 2 : 3),
                n
              );
            },
            prefix: !0,
          ...
          parser: function (t, e, i, r, n, a) {
            var o,
              ...
              m = this.format(
                (c
                  ? d
                    ? c.getPropertyValue(_ + "-x") +
                      " " +
                      c.getPropertyValue(_ + "-y")
                    : c.getPropertyValue(_)
          ...
          parser: function (t, e, i, r, n, a) {
            ...
            return (
              9 > d
                ...
                : ((o = this.format(G(t, this.p, s, !1, this.dflt))),
                  (e = this.format(e))),
        ...
        ve("border", {
          ...
          parser: function (t, e, i, r, n, a) {
            return this.parseComplex(
              t.style,
              this.format(
                G(t, "borderTopWidth", s, !1, "0px") +
                  " " +
                  G(t, "borderTopStyle", s, !1, "solid") +
                  " " +
                  G(t, "borderTopColor", s, !1, "#000")
              ),
              this.format(e),
              n,
              a
      ...
      ve("opacity,alpha,autoAlpha", {
        ...
        parser: function (t, e, i, r, n, a) {
          ...
          return (
            ...
            h &&
              1 === o &&
              "hidden" === G(t, "visibility", s) &&
              0 !== e &&
              (o = 0),
            U
              ? (n = new ce(l, "opacity", o, e - o, n))
              : ((n = new ce(l, "opacity", 100 * o, 100 * (e - o), n)),
                (n.xn1 = h ? 1 : 0),
                (l.zoom = 1),
                (n.type = 2),
      ...
      ve("className", {
        parser: function (t, e, r, n, a, o, l) {
          var h,
            ...
            d = t.style.cssText;
          if (
            ((a = n._classNamePT = new ce(t, r, 0, 0, a, 2)),
            (a.setRatio = Fe),
            (a.pr = -11),
            (i = !0),
            (a.b = c),
                  ...
                  (m && P.test(_))
                    ? (m ||
                        ...
                        (_ =
                          ...
                          _.join(",") +
                          ")")),
                      (i = de(v, a, p, _, !0, "transparent", i, 0, n)))
