(function () {
  ...
  d.removeChart = function (a) {
    ...
    0 === b.length &&
      d.updateInt &&
      (clearInterval(d.updateInt), (d.updateInt = NaN));
  };
  d.isModern = !0;
    ...
    if (b) {
      ...
      for (l = 0; l < c.length; l++) {
        var m = c[l],
          n = b[m];
        void 0 !== n &&
          ((n = f ? d.addPrefix(n, k, g, e) : d.formatNumber(n, e)),
          (a = a.replace(
            new RegExp("\\[\\[" + h + "" + m + "\\]\\]", "g"),
            n
          )));
  ...
  d.AxisBase = d.Class({
    ...
    parseDatesDraw: function () {
      ...
      var A = Math.ceil(this.timeDifference / z) + 5,
        C = (l = d
          .resetDateToMin(new Date(this.startTime - z), B, w, t)
          .getTime());
      if (
        (g == B && 1 == w && this.centerLabelOnFullPeriod) ||
        this.autoWrap ||
        this.centerLabels
      )
        (n = z * this.stepWidth),
      ...
      if (0 < this.gridCountR)
        for (
          ...
          "MM" == B &&
            ((h = (p - l) / z),
            1.5 <= (p - l) / z &&
              ((p = p - (h - 1) * z + d.getPeriodDuration("DD", 3)),
          ...
          if ("radar" == b.type) {
            ...
            this.rotate
              ? "date" == this.type &&
                ...
                (J = (-z * this.stepWidth) / 2)
              : "date" == this.type && (h = this.axisWidth - h);
          f = !1;
          this.nextPeriod[g] &&
            (f = this.checkPeriodChange(this.nextPeriod[g], 1, p, l, g));
          l = !1;
          ...
          if ((a == k && !c) || (a == A && !e)) f = " ";
          this.labelFunction &&
            (f = this.labelFunction(f, new Date(p), this, B, w, m).toString());
          this.boldLabels && (l = !0);
    ...
    checkPeriodChange: function (a, b, c, e, h) {
      ...
      return "DD" == a && "hh" != h && c - b < d.getPeriodDuration(a, e)
        ? !1
        : c != b
        ? !0
        : !1;
  ...
  d.ValueAxis = d.Class({
      ...
      if (
        ...
        !0 === h
          ? ((u =
            ...
            u > this.logGridLimit &&
              ((t = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1),
              (f = Math.round(Math.log(this.minReal) * Math.LOG10E)),
              t > this.gridCountR && (p = Math.ceil(t / this.gridCountR))))
        ...
        if (0 < B) {
          ...
          for (g = this.fillAlpha = 0; g < B; g++) {
            ...
            isNaN(C) && ((J -= 3), (C = J + 3));
            isNaN(C - J) ||
              ((x = new this.guideFillRenderer(this, J, C, A)),
              this.pushAxisItem(x, D),
              (x = x.graphics()),
              (A.graphics = x),
        ...
        this.minorGridEnabled &&
          (H = this.getMinorGridStep(y, this.stepWidth * y));
                  ...
                  "100%" == b &&
                    ...
                    0 > c
                      ? ((m.values.close = d.fitToBounds(c + e[p], -100, 100)),
                        (m.values.open = e[p]),
                        (e[p] = m.values.close))
                      : ((m.values.close = d.fitToBounds(c + h[p], -100, 100)),
                        (m.values.open = h[p]),
                        (h[p] = m.values.close))))));
    },
    ...
    zoomToValues: function (a, b, c) {
      ...
      if (this.logarithmic) {
        ...
        this.relativeStart =
          (Math.log(a) / Math.LN10 - Math.log(e) * Math.LOG10E) / d;
    ...
    construct: function (a) {
      ...
      "H" == a.orientation
        ...
        : ((this.axisWidth = a.height),
          "right" == a.position
            ? ((e = d.line(p, [0, 0, -g], [0, n, n - k], e, h, c)),
              (k = m + k),
              (c = c / 2 + f + g + q + l - 1))
            : ((e = d.line(p, [0, 0], [0, n], e, h, c)),
              (k = m),
              (c = -c / 2 - f + l)));
      e.translate(c, k);
      c = b.container.set();
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
      ...
      var ia = a.counter,
        ...
        za;
      g
        ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id),
          (P = !0),
          ...
          isNaN(g.labelOffset) || (Z = g.labelOffset))
        : "" === c && (A = 0);
      ...
      P &&
        ...
        ((ba =
          a.autoWrap && 0 === n
            ? d.wrappedText(y, c, u, t, r, ga, k, Math.abs(h), 0)
            : d.text(y, c, u, t, r, ga, k)),
        (ga = ba.getBBox()),
        (ha = ga.width),
        (Pa = ga.height));
      if ("H" == Oa) {
        if (
          (0 <= b &&
            ...
            (0 < A &&
              0 < z &&
              b + l <= ya + 1 &&
              ((fa = d.line(y, [b + l, b + l], [0, A], B, z, D)), x.push(fa)),
            0 < C &&
              ((za = d.line(
                y,
                [b, b + va, b + va],
          ...
          1 == ia &&
            ...
            !m &&
            ca < ya &&
            ((e = d.fitToBounds(b, 0, ya)),
            (ca = d.fitToBounds(ca, 0, ya)),
            (Y = e - ca),
            0 < Y &&
              ((Ca = d.rect(y, Y, a.height, R, L)),
          ...
          "bottom" == ea
            ? ((v += X + r / 2 + da),
              I
                ? (0 < n
                    ? ((v = X - (ha / 2) * Math.sin(T) - A - 3),
                      (G += (ha / 2) * Math.cos(T) - 4 + 2))
                    : 0 > n
                    ? ((v = X + ha * Math.sin(T) - A - 3 + 2),
                      (G += -ha * Math.cos(T) - Pa * Math.sin(T) - 4))
                    : (v -= A + r + 3 + 3),
                  (v -= Z))
                : (0 < n
                    ? ((v = X + (ha / 2) * Math.sin(T) + A + 3),
            ...
            : ((v += la + r / 2 - da),
              ...
              I
                ? (0 < n
                    ? ((v = (ha / 2) * Math.sin(T) + A + 3),
                      (G -= (ha / 2) * Math.cos(T)))
                    : (v += A + 3),
                  (v += Z))
                : (0 < n
                    ? ((v = -(ha / 2) * Math.sin(T) - A - 6),
                      (G += (ha / 2) * Math.cos(T)))
                    : (v -= A + r + 3 + w + 3),
                  (v -= Z))),
          "bottom" == ea
            ? (Y = (I ? X - A - 1 : X + w - 1) + da)
            : ((ma = va), (Y = (I ? la : la - A - w + 1) - da)),
          f && (G += f),
          (f = G),
        ...
        0 <= b &&
          ...
          (0 < A &&
            0 < z &&
            b + l <= X + 1 &&
            ((fa = d.line(y, [0, A + 1], [b + l, b + l], B, z, D)), x.push(fa)),
          0 < C &&
            ((za = d.line(
              y,
              [0, va, ya + va],
        ...
        "right" == ea
          ...
          ? ((G += A + 4 - da),
            ...
            g && ((G += va), (v += la)),
            (G += Z))
          : ((G += -A - w - 4 - 2 - da), (v -= 2), (G -= Z));
        fa &&
          ("right" == ea
            ? ((ma += va + da + ya - 1), (Y += la), (ma = I ? ma - w : ma + w))
            : ((ma -= da), I || (ma -= A + w)));
        f && (v += f);
        I = -3;
        "right" == ea && (I += la);
  ...
  d.AmChart = d.Class({
    ...
    afterWrite: function (a) {
      if ((a = "object" != typeof a ? document.getElementById(a) : a)) {
        ...
        l &&
          d.AmExport &&
          !this.AmExport &&
          (this.AmExport = new d.AmExport(this, l));
        this.amExport &&
          d.AmExport &&
    ...
    addListeners: function () {
      ...
      document.addEventListener
        ? (a.panEventsEnabled &&
            ((b.style.msTouchAction = "none"), (b.style.touchAction = "none")),
  ...
  d.AmGraph = d.Class({
    ...
    createSerialGraph: function () {
      ...
      if (
        ...
        t
          ? ((ha = q),
            ...
            (vb = Math.abs(ib - Ka)),
            (hb = tb = 0),
            f.reversed ? ((ba = 0), (gb = Ka)) : ((ba = Ka), (gb = 0)))
          : ((Pa = n),
            (ha = Math.abs(Nb - Ka)),
            (vb = n),
            (ub = Math.abs(ib - Ka)),
      ...
      if ("line" == g || "step" == g || "smoothedLine" == g) {
        if (0 < P) {
          ...
          if (this.fillColorsField)
            for (M = P; -1 < M; M--)
              if (((G = e[M]), (v = G.axes[f.id].graphs[b]), v.fillColors)) {
          ...
          if (this.dashLengthField)
            for (M = P; -1 < M; M--)
              if (
                ((G = e[M]), (v = G.axes[f.id].graphs[b]), !isNaN(v.dashLength))
              ) {
      ...
      for (M = P; M <= ia; M++) {
        ...
        if (Ia) {
          ...
          isNaN(ta) ||
            ((N = f.getCoordinate(ta, xb)),
            m && "regular" != L && "100%" != L && ((Ta = ta), (ta = N = NaN)));
          m &&
          ...
          t
            ? ((E = F),
              ...
              (pa = qa),
              (ra = sa))
            : ((O = E = na), isNaN(ta) && !this.fillToGraph && (N = la));
          if ((!Db && W < ta) || (Db && W < za))
            (v.isNegative = !0),
              Qa && (Ma = Qa),
              Za && (Va = Za),
          ...
          isNaN(W) ||
            (m
              ? W > Ta
                ? (Sa && ($a = !0), (Sa = !1))
                : (Sa || ($a = !0), (Sa = !0))
              : (v.isNegative = W < Oa ? !0 : !1),
            (za = W));
          var Qb = !1;
          I && a.chartScrollbar.ignoreCustomColors && (Qb = !0);
          Qb ||
            (void 0 != v.color && (Ma = v.color),
          ...
          switch (g) {
            ...
            case "smoothedLine":
              if (isNaN(W))
                y ||
                  (this.drawSmoothedGraph(x, w, U, V),
                  (x = []),
                  (w = []),
                  (U = []),
                  (V = []));
                ...
                t
                  ? (isNaN(B) || (x.push(B), w.push(F - xa)),
                    ...
                    !Ra ||
                      isNaN(N) ||
                      isNaN(O) ||
                      (isNaN(A) || (U.push(A), V.push(N - xa)),
                      U.push(O),
                      V.push(N - xa),
                      U.push(O),
                      V.push(N + Ga)))
                  : (isNaN(z) || (w.push(z), x.push(E - xa)),
                    x.push(E - xa),
                    w.push(F),
                    x.push(E + Ga),
                    w.push(F),
              ...
              if (!isNaN(W)) {
                ...
                if (!((W < Rb && ob < Rb) || (W > Sb && ob > Sb))) {
                  ...
                  if (t) {
                    "3d" == L
                      ? ((Q =
                          F -
                          (r / 2 - this.depthCount + 1) * (k + T) +
                          T / 2 +
                          R * ea),
                        (S = O + H * ea),
                        (Ba = ea))
                      : ((Q = Math.floor(F - (r / 2 - ea) * (k + T) + T / 2)),
                        (S = O),
                        (Ba = 0));
                    K = k;
                    wa = E;
                ...
                if (ua) {
                  ...
                  (v.url || this.showHandOnHover) &&
                    Ea.setAttr("cursor", "pointer");
                  if (!I) {
                    "none" == L &&
                      (J = t ? (this.end + 1 - M) * D - c : D * M + c);
                    "3d" == L &&
                      (t
                        ? ((J =
                            (this.end + 1 - M) * D - c - 1e3 * this.depthCount),
                          (wa += H * this.columnIndex),
                          (ja += H * this.columnIndex),
                          (v.y += H * this.columnIndex))
                        : ((J = (D - c) * (M + 1) + 1e3 * this.depthCount),
            ...
            case "ohlc":
              if (!(isNaN(ta) || isNaN(Bb) || isNaN(Cb) || isNaN(W))) {
                ...
                if (t) {
                  ...
                  0 <= O &&
                    O <= oa &&
                    (qb = d.line(h, [O, O], [Jb, Ub], Ha, X, ca, da));
                  0 < F &&
                    F < q &&
                    (pb = d.line(h, [pa, ra], [F, F], Ha, X, ca, da));
                  0 <= E &&
                    E <= oa &&
                    (rb = d.line(h, [E, E], [Ub, Kb], Ha, X, ca, da));
                } else {
                  ka = F;
                  "open" == l && (ka = N);
                  "high" == l && (ka = sa);
                  ...
                  0 <= N &&
                    N <= Fa &&
                    (qb = d.line(h, [Lb, Vb], [N, N], Ha, X, ca, da));
                  0 < E &&
                    E < n &&
                    (pb = d.line(h, [E, E], [qa, sa], Ha, X, ca, da));
                  0 <= F &&
                    F <= Fa &&
                    (rb = d.line(h, [Vb, Mb], [F, F], Ha, X, ca, da));
                }
                fa.push(qb);
                fa.push(pb);
                fa.push(rb);
      ...
      if (1 < a.length) {
        ...
        if (0 < g || 0 < B)
          if (
            ...
            0 < g &&
              ((b = d.polygon(l, p, r, u, g, 1, "#000", 0, a, f)),
    ...
    drawSmoothedGraph: function (a, b, c, e) {
      if (1 < a.length) {
        ...
        k.push(m.path);
        void 0 !== r &&
          ((n = new d.Bezier(g, a, b, r, w, n, t, 0, h)),
    ...
    handleRollOut: function (a, b) {
      ...
      ((c = this.chart.chartCursor) && c.valueBalloonsEnabled) ||
        this.hideBalloon();
    },
    ...
    showGraphBalloon: function (a, b, c, e, h) {
      ...
      if (g && g.enabled && this.showBalloon && !this.hidden) {
        ...
        m && "" !== m
          ...
          : (this.hideBalloonReal(), this.resizeBullet(a, e, h));
  ...
  d.SimpleChartScrollbar = d.Class({
    ...
    clipDragger: function (a) {
      ...
      if (b) {
        ...
        if (this.rotate) {
          if (
            ((c = 0), (h = this.width + 1), this.clipY != d || this.clipH != b)
          )
            f = !0;
        } else if (
          ((d = 0), (b = this.height + 1), this.clipX != c || this.clipW != h)
        )
          f = !0;
        f &&
          (this.clipAndUpdate(c, d, h, b),
    ...
    percentZoom: function (a, b) {
      if (this.dragger && this.enabled) {
        ...
        var c, d, h;
        this.rotate
          ? ((c = this.height), (d = c - c * b), (h = c - c * a))
          : ((c = this.width), (h = c * b), (d = c * a));
    ...
    iconRollOver: function () {
      this.rotate
        ? this.chart.setMouseCursor("ns-resize")
        : this.chart.setMouseCursor("ew-resize");
      this.handleMouseOver();
    },
    getDBox: function () {
    ...
    draw: function () {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          this.className &&
            (n.className =
              n.className + " " + A + "-balloon-div-" + this.className);
          A = n.style;
          ...
          "H" != x
            ? ((C = a - D / 2),
              b < k + B + 10 && "down" != x
                ? ((R = !0), e && (b += z), (z = b + y), (this.deltaSignY = -1))
                : (e && (b -= z), (z = b - B - y), (this.deltaSignY = 1)))
            : (2 * y > B && (y = B / 2),
              (z = b - B / 2),
              a < g + (l - g) / 2
                ? ((C = a + y), (this.deltaSignX = -1))
                : ((C = a - D - y), (this.deltaSignX = 1)));
          z + B >= m && (z = m - B);
          z < k && (z = k);
          C < g && (C = g);
          C + D > l && (C = l - D);
          ...
          this.drop
            ? ((g = D / 1.6),
              ...
              "V" == x && (x = "down"),
              "H" == x && (x = "left"),
              "down" == x && ((C = a + 1), (z = b - g - g / 3)),
              "up" == x && ((l = 180), (C = a + 1), (z = b + g + g / 3)),
              "left" == x && ((l = 270), (C = a + g + g / 3 + 2), (z = b)),
              "right" == x && ((l = 90), (C = a - g - g / 3 + 2), (z = b)),
              (k = z - H / 2 + 1),
              (m = C - J / 2 - 1),
              (q = d.drop(h, g, l, q, u, r, p, Z)))
            : 0 < w || 0 === y
            ? (0 < L &&
                ((a = d.rect(h, D, B, q, 0, r + 1, P, L, w)),
                d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                f.push(a)),
              (q = d.rect(h, D, B, q, u, r, p, Z, w)))
            : ((t = []),
              (w = []),
              "H" != x
                ? ((g = a - C),
                ...
                : ((x = b - z),
                  ...
                  (t =
                    a < g + (l - g) / 2
                      ? [0, 0, C < a ? 0 : a - C, 0, 0, D, D, 0]
                      : [D, D, C + D > a ? D : a - C, D, D, 0, 0, D])),
              0 < L &&
                ((a = d.polygon(h, t, w, q, 0, r, P, L)),
                a.translate(1, 1),
                f.push(a)),
          ...
          0 < this.animationDuration &&
            ...
            f.animate({ translate: C - h + "," + z }, b, "easeOutSine"),
            n &&
...
(function () {
  ...
  d.AmCoordinateChart = d.Class({
    ...
    construct: function (a) {
      ...
      this.colors =
        "#ea4c89 #00C6D7 #052963 #0D8ECF #2A0CD0 #CD0D74 #021f4e #ea4c89 #ea4c89 #DDDDDD #999999 #333333 #990000".split(
          " "
        );
    ...
    parsePartSerialData: function (a, b, c, e) {
      ...
      for (w = b; w < c; w++) {
        ...
        if (
          k &&
          (m.categoryFunction
            ? (b = m.categoryFunction(b, C, m))
            : (!B || b instanceof Date || (b = b.toString() + " |"),
...
(function () {
  ...
  d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
    ...
    d.isModern &&
      "radial" == t &&
      k.grad &&
      (k.grad.setAttribute("gradientUnits", "userSpaceOnUse"),
      k.grad.setAttribute("r", f),
      k.grad.setAttribute(
        "gradientTransform",
        "translate(" + (b - a.width / 2) + "," + (c - a.height / 2) + ")"
      ));
    k.pattern(q, NaN, p);
    e.wedge = k;
    e.push(k);
          ...
          ? (c.frame++,
            "translate" == g
              ? ((k = c.from.split(",")),
                ...
                (l = Number(l[1])),
                (m =
                  0 === m - g ? m : Math.round(d[c.effect](0, h, g, m - g, e))),
                (c =
                  0 === l - k ? l : Math.round(d[c.effect](0, h, k, l - k, e))),
                (g = "transform"),
                (c = "translate(" + m + "," + c + ")"))
              : ((l = Number(c.from)),
                (k = Number(c.to)),
...
(function () {
  ...
  d.AmLegend = d.Class({
    construct: function (a) {
      ...
      this.borderColor = this.color = "#052963";
      this.borderAlpha = 0;
    ...
    arrangeEntries: function () {
      ...
      if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
        "center" == this.align
          ? (b = f + (n - w.width) / 2)
          : "right" == this.align && (b = f + n - w.width);
      y.translate(b, m + 1);
    ...
    createEntry: function (a) {
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        if (this.useGraphSettings) {
          ...
          (g = this.createMarker(c, e, h, void 0, void 0, void 0, r, g)) &&
            g.translate(m / 2, m / 2);
        }
        ...
        (f = this.switchType) &&
          ...
          0 < m &&
          ("x" == f
            ? ((t = this.createX()), t.translate(m / 2, m / 2))
            : (t = this.createV()),
          (t.dItem = a),
          !0 !== a.hidden
            ? "x" == f
        ...
        g &&
          (m <= t &&
            g.translate(p, m / 2 + this.ly - t / 2 + (t + 2 - m) / 2 - q),
        ...
        e &&
          ...
          (u = this.labelWidth),
          (u = isNaN(u)
            ? d.text(this.container, e, f, b.fontFamily, t, "start")
            : d.wrappedText(
                this.container,
                e,
                f,
